...
export default function SavedJobs() {
  ...
  // Audio description
  const pageAudioDescription = t("jobSeeker.savedJobs.audioDescription");
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-foreground mb-1">
              {t("jobSeeker.savedJobs.title")}
            </h1>
            <p className="text-muted-foreground">
              {t("jobSeeker.savedJobs.subtitle")}
            </p>
          </div>
            ...
            {isLoading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground mb-6">
                  {t("jobSeeker.savedJobs.startSaving")}
                </p>
                <Button asChild>
                  <Link href="/job-seeker/search">
                    {t("jobSeeker.savedJobs.browseJobs")}
                  </Link>
                </Button>
              </div>
            )}
